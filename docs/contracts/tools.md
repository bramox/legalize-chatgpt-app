...
```json
{
  "type": "object",
  "additionalProperties": false,
  "required": ["identifier", "base_revision", "target_revision"],
  "properties": {
    "identifier": { "type": "string", "minLength": 3, "maxLength": 80 },
    "base_revision": { "type": "string", "minLength": 7, "maxLength": 64 },
    "target_revision": { "type": "string", "minLength": 7, "maxLength": 64 },
    "article_number": { "type": "string", "maxLength": 40 },
    "jurisdiction": {
      "type": "string",
      "enum": ["es", "es-an", "es-ar", "es-as", "es-cb", "es-cl", "es-cm", "es-cn", "es-ct", "es-ex", "es-ga", "es-ib", "es-mc", "es-md", "es-nc", "es-pv", "es-ri", "es-vc"]
    },
...
```json
{
  ...
  "comparison": {
    ...
    "article_number": "1",
    "before_text": "Bounded before text.",
    "after_text": "Bounded after text.",
    "diff_summary": "Human-readable summary of changed source text.",
    "truncated": false
  }
}
```

If the comparison cannot fit under `max_chars`, return bounded before/after text with `truncated: true`.
