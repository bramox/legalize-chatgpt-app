...
- These workflow agents are compatibility assets. If automatic delegation is not precise enough, make the current proof-loop phase more explicit in natural language.
